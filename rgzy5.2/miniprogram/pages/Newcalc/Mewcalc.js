...
Page({
  ...
  nextQuestion: function() {
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      if (app.globalData.userInfo != null)
        username = app.globalData.userInfo.nickName;
      var id_key = 'wrongbook of ' + username;
    ...
    if (app.globalData.userInfo != null)
      username = app.globalData.userInfo.nickName;
    var id_key = 'history of ' + username;
    db.collection('movies').add({
      data: {
        _id: id_key,
        list: []
    ...
    setTimeout(function() {
      ...
      if (app.globalData.answeredToday >= app.globalData.questionNum) {
        ...
        var tmp = [app.globalData.rightToday, app.globalData.wrongToday, Math.floor(100.0 * app.globalData.rightToday / app.globalData.answeredToday)]
        var tmp2 = '   得分'+tmp[2]+'\n正确数：'+tmp[0]+'   错误数：'+tmp[1]
